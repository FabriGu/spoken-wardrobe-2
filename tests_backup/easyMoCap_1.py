...
easyMocapPath = Path(__file__).parent.parent / "external" / "EasyMocap" 
if not easyMocapPath.exists():
    print(f"✗ TripoSR not found at: {easyMocapPath}")
    print("\nExpected structure:")
    ...
    print(f"✓ EasyMoCap found at: {easyMocapPath}")



sys.path.insert(0, str(easyMocapPath))
...
def main():
    ...
    meshes = list(mesh_dir.glob("*.obj")) if mesh_dir.exists() else []
